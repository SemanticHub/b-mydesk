...
<script type="text/javascript">
    $(function () {
        $('#Design_team_id').on('change', function (e) {
            $.ajax({
                url: "/communications/teams/members?team_id=" + $('#Design_team_id').val(),
                type: "GET",
                success: function (data) {
                    console.log(data);
                    $('#Design_team_members').html(data);
                },
            });
            return false;
        });
        $('#save-assign').on('click', function (e) {
            ...
            $.ajax({
                url: "/communications/design/assignToTeam?id=" + $('#Design_id').val(),
                type: "POST",
