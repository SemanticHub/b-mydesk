...
<div class="content" style="background: #eee; padding: 0.5em">
    ...
    <div class="ui fluid form segment" style="background: rgba(0, 0, 0 , 0.1); margin-top: 0">                   
        ...
        <div style="display: block; border: 1px solid; margin-top: 0px;" class="ui info message">
            <ul>
                <li>
                    ...
                    <?php echo Settings::model()->findByPk($model->design_id)->type ?>  
        ...
        <div class="field">
            ...
            <?php echo $form->dropDownList($model, 'team_id', CHtml::listData(Teams::model()->findAll(), 'id', 'name'), array('type' => 'text', 'class' => 'ui mini selection ', 'placeholder' => 'Select')); ?>
...
<script type="text/javascript">
    $(function () {
        $('#Printing_team_id').on('change', function (e) {
            $.ajax({
                url: "/communications/teams/members?team_id=" + $('#Printing_team_id').val(),
                type: "GET",
                success: function (data) {
                    console.log(data);
                    $('#Printing_team_members').html(data);
                },
            });
            return false;
        });
        $('#save-assign').on('click', function (e) {
            ...
            $.ajax({
                url: "/communications/printing/assignToTeam?id=" + $('#Printing_id').val(),
                type: "POST",
