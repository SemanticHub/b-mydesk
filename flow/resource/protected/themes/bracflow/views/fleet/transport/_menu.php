...
$this->menu = array(
    array('itemOptions' => array('teal' => ($supervisorCount) ? $supervisorCount : '0'), 'label' => 'Supervisor Inbox', 'url' => array('//fleet/transport/supervisor'), 'visible' => TransportFlowSupervisor::model()->isSupervisor(), 'active' => $active == 'supervisor' ? 'active' : ''),
