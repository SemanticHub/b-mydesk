...
class Photography extends CActiveRecord {
    ...
    public function attributeLabels() {
        return array(
            ...
            'feedback_procecss' => 'How did you find the process?',
            'feedback_time' => 'How did you find the overall time management?',
            'feedback_quality' => 'How do you rate yout overall experience?',
