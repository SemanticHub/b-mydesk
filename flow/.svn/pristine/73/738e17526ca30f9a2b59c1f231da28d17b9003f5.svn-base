...
//			),
                        array('allow', // allow admin user to perform 'admin' and 'delete' actions
                            'actions' => array('create', 'update', 'admin', 'delete', 'userinfo'),
                            //'users'=>array('admin'),
	...
	{
		$dataProvider=new CActiveDataProvider('CommFlowSupervisor');
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['CommFlowSupervisor']))
			$model->attributes=$_GET['CommFlowSupervisor'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='comm-flow-supervisor-form')
		{
