...
class Transport extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('transport_flow_supervisor_id', 'checkRequiredSupervisor'),
    ...
    public function checkRequiredSupervisor($attributes, $params) {
        if (!$this->travel_type == 1 && $this->transport_flow_supervisor_id == "") {            
            $this->addError('transport_flow_supervisor_id', 'Supervisor cannot be blank.');
        }
    }
