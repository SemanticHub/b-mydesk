...
class DefaultController extends Controller {
    ...
    public $feedback_process_options = array(
        'a' => 'Easy',
        'b' => 'Satisfactory',
        'c' => 'Complicated',
        'd' => 'Lengthy/ Time consuming',
    );
    public $feedback_time_options = array(
        'a' => 'All communication was on time and the product was delivered before the expected deadline',
        'b' => 'All communication and the product deliverey were on time',
        'c' => 'Both comminication and the product delivery were slightly delayed',
        'd' => 'Communication was on time but the product delivery was delayed',
    );
    public $feedback_quality_options = array(
        'a' => 'Excellent',
        'b' => 'Good',
        'c' => 'Satisfactory',
        'd' => 'Not so good',
    ...
    public function actionFeedback() {
        ...
        $this->render('feedback', array(
            'model' => $model,
            'feedback_process_options' => $this->feedback_process_options,
            'feedback_time_options' => $this->feedback_time_options,
            'feedback_quality_options' => $this->feedback_quality_options,
        ));
    }
