...
?>
<h3 class="ui header dividing" style="margin-top: 0">Feedback Reports </h3>
    ...
    <div class="ui grid com-form">        
        <div class="five wide column">
            ...
            <div class="field">
                ...
                <?php
                echo CHtml::dropDownList('team_member', '', CHtml::listData($teamMembers, 'user_pin', 'user_name'), array('class' => 'ui mini selection ', 'empty' => 'Select'));
                ?>
            </div>
        </div>        
