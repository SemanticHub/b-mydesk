...
$teamUser = $hrdService->getProgrammeUsers("H17");
...
<div class="ui fluid form segment" style="background: rgba(0, 0, 0 , 0.1); margin-top: 0">
    ...
    <?php //echo $form->dropDownList($model,'user_id', CHtml::listData(User::model()->findAll(), 'id', 'username') , array( 'type'=>'text','class'=>'ui mini selection ','placeholder'=>'Select')); ?>            
    ...
    <div class="field">
        ...
        echo $form->dropDownList($model, 'user_pin', CHtml::listData($teamUser, 'PIN', function($item) {
                ...
                }), array('type' => 'text', 'class' => 'ui mini selection ', 'placeholder' => 'Select'));
        ?>
